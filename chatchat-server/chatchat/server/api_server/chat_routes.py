...
from chatchat.server.api_server.api_schemas import AgentChatInput, AgentChatOutput, OpenAIChatInput, OpenAIChatOutput, \
    openai_request
from chatchat.server.chat.chat import chat
from chatchat.server.db.repository import add_message_to_db
from chatchat.server.utils import (
    get_checkpointer,
    get_graph_memory_type,
    create_agent_models,
    get_OpenAIClient,
    get_prompt_template,
    get_tool,
...
@chat_router.post("/chain/completions", summary="兼容 openai 的统一 chat 接口")
